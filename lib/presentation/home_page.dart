...
import '../domain/weather_forcast_model/weather_forcast_model.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget buildInitialInput() {
    // final firstWeatherData = weather.firstOrNull;
      ...
      child: BlocBuilder<WeatherBloc, WeatherState>(
        builder: (context, state) {
          if (state.loading) {
            ...
            final firstWeatherData = state.weather.firstOrNull;
            print(state.weather);
            return Column(
              spacing: 20,
              children: [
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            '${firstWeatherData?.windSpeed ?? "0"} km/h',
                                            style: TextStyle(
                                              fontSize: 14,
                                              fontWeight: FontWeight.w700,
                                            ),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${firstWeatherData?.temperature ?? "0"}°C',
                                        style: TextStyle(fontSize: 18),
                                      ),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${firstWeatherData?.forecast?[0].temperature ?? "0"}°C',
                                        style: TextStyle(fontSize: 18),
                                      ),
                                      Image.asset('assets/cloudy-1.png'),
                                      const Text(
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${firstWeatherData?.forecast?[1].temperature ?? "0"}°C',
                                        style: TextStyle(fontSize: 18),
                                      ),
                                      Image.asset('assets/cloudy-1.png'),
                                      const Text(
            ...
            return Text('Enter a city to fetch weather data');
          }
        },
      ),
    );
